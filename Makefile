...
GPP_PARAMS = -m32 -g -ffreestanding -Iinclude -I. -fno-use-cxa-atexit -nostdlib -fno-builtin -fno-rtti -fno-exceptions -fno-common -fno-omit-frame-pointer -DKDBG_ENABLE=$(KDBG_ENABLE) -DKDBG_LEVEL=$(KDBG_LEVEL) -MMD -MP
ASM_PARAMS = --32 -g
...
INSTALLER_CFLAGS = -m32 -g -ffreestanding $(INSTALLER_INCLUDES) -fno-use-cxa-atexit -nostdlib -fno-builtin -fno-rtti -fno-exceptions -fno-common -fno-omit-frame-pointer -DKDBG_ENABLE=0 -DKDBG_LEVEL=0 -MMD -MP
...
# Header dependency files generated by -MMD -MP
-include $(objects:.o=.d) $(INSTALLER_OBJECTS:.o=.d)
...
build-installer: $(KERNEL_INSTALLER_BIN) $(INSTALLER_PAK)
	mkdir -p $(BUILD_DIR)/installer_iso/boot/grub
	cp $(KERNEL_INSTALLER_BIN) $(BUILD_DIR)/installer_iso/boot/kernel.bin
	cp $(INSTALLER_PAK) $(BUILD_DIR)/installer_iso/installer.pak
	echo 'set timeout=0' > $(BUILD_DIR)/installer_iso/boot/grub/grub.cfg
	echo 'set default=0' >> $(BUILD_DIR)/installer_iso/boot/grub/grub.cfg
	echo 'terminal_output gfxterm' >> $(BUILD_DIR)/installer_iso/boot/grub/grub.cfg
	echo '' >> $(BUILD_DIR)/installer_iso/boot/grub/grub.cfg
	echo 'menuentry "Hashx86-OS Installer" {' >> $(BUILD_DIR)/installer_iso/boot/grub/grub.cfg
	echo '  multiboot /boot/kernel.bin' >> $(BUILD_DIR)/installer_iso/boot/grub/grub.cfg
